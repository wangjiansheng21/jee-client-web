...
import org.jee.boot.client.web.request.wx.GetAccesTokenRequest;
...
public class WXController {
     ...
     * 获取微信accesToken
     *
     * @param getAccesTokenRequest
     * @return
     */
    @PostMapping("/getAccesToken")
    public RpcResponse<AccesTokenVO> getAccesToken(@RequestBody GetAccesTokenRequest getAccesTokenRequest) {
        return wxService.getAccesToken(getAccesTokenRequest.getAppId());
    }
}
